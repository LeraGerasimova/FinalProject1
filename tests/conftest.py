...
def web_browser(request, selenium):
    browser = selenium  # browser.maximize_window()
    browser.set_window_size(1400, 1000) # Вернуть экземпляр браузера в тестовый пример:
    yield browser
...
def get_webdriver(get_chrome_options):
    ...
    driver = webdriver.Chrome(executable_path=r'C:/Users/Public/Driver/chromedriver.exe', options=options)
    return driver
